...
<form action="/editBook" method="post">
  <div style="margin-top:10px;" class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="bookId" class="form-control" value="${data }"  id="bookid" placeholder="bookid">
    </div>
  </div>
   ...
   <div class="form-group row">
    <div class="col-sm-10">
      <button style="margin-left:200px;" type="submit" class="btn btn-primary">Update Book</button>
    </div>
  </div>
  </div>
</form>
